    ...
    return(
            ...
            <div className="w-[100%] h-[100%]">
                <div className="px-5">
                    ...
                    <p className="text-center font-light text-xl translate-y-28 max-lg:text-lg max-sm:text-sm max-md:translate-y-20">3D Artists <span className="px-4">|</span> Architects <span className="px-4">|</span> Designers <span className="px-4">|</span> Game Developers</p>
                </div>
