    ...
    <div className={`bg-[#2e2e2e] flex flex-col ${poppins.className}`}>
        ...
        buttons={
          <div className="flex items-center gap-2 justify-end px-2">
            <button
              ...
              className={`${!translate ? "border border-white text-white" : ""} px-2 py-1 rounded-lg`}
            >
              ES
            </button>
            |
      ...
      <Description
        text={
          !translate ? (
            <p className="lg:w-[60%] mx-auto text-xl max-sm:text-base">
              Una herramienta digital interactiva diseñada para optimizar los procesos de{" "}
            ...
            <p className="lg:w-[60%] mx-auto text-xl max-sm:text-base">
              ...
              designed to streamline and enhance the marketing and sales strategies for Real State
            </p>
          )
        }
        cards={cards.map((data) => (
          <div
            key={data.title}
            className="p-4 rounded-xl bg-[#404040] shadow-xl flex flex-col gap-4 max-w-[200px] h-[150px] items-center justify-between"
          >
            {data.icon}
...
export default ArcanePlayerTest;
